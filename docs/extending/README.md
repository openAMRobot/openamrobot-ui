...
Hands-on guides for adding things to this UI, without changing how Map,
Route, Control, Info, or Blocks already behave. If you haven't read the
conceptual lessons yet, start with
[`docs/lessons/`](../lessons/README.md) — these guides assume you already
know what a topic, a relay, and the shared ROS connection are.
...
| Add a new drag-and-drop block to the Blocks page | [`add-a-blockly-block.md`](add-a-blockly-block.md) |
...
([Lesson 06](../lessons/06-the-five-pages.md) for pages,
